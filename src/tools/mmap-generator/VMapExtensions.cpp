...
namespace VMAP
{
    ...
    // declared in src/game/vmap/MapTree.h
    ...
    // declared in src/game/vmap/VMapManager2.h
    void VMapManager2::getInstanceMapTree(InstanceTreeMap& instanceMapTree)
    {
        instanceMapTree = iInstanceMapTrees;
    }

    // declared in src/game/vmap/WorldModel.h
    ...
    // declared in src/game/vmap/ModelInstance.h
