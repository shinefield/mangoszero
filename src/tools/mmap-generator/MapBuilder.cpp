...
namespace MMAP
{
                                      ...
                                      dtNavMesh* navMesh)
    {
        ...
        config.walkableClimb = m_bigBaseUnit ? 2 : 3;   // keep less than walkableHeight
        config.minRegionArea = rcSqr(60);
        config.mergeRegionArea = rcSqr(50);
        config.maxSimplificationError = 1.0f;       // eliminates most jagged edges (tinny polygons)
        config.detailSampleDist = config.cs * 5;
